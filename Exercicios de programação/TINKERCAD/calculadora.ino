...
void setup()
{
  ...
  do{
    ...
    n1 = Serial.parseFloat(); // Aqui você pode futuramente substituir por leitura real


    Serial.println("Digite o segundo numero:");
    while (!Serial.available()); // Aguarda entrada do usuário
    n2 = Serial.parseFloat(); // Aqui você pode futuramente substituir por leitura real
